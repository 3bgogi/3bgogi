...
<body>
	<div class="container-fluid  dashboard-content">
		<form id="addProductAndOptionForm" style="display: none;">
		
		</form>
		<form class="row" name="addProductOptionListSearchForm" action="<c:url value='/order/matching/product_list_result.do'/>" method="get">
			<c:forEach var="serialList" items="${orSerialSpecialNumberList }">			
				<input type="hidden" value="${serialList }" name="orSerialSpecialNumbers">
			</c:forEach>
